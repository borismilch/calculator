...
},{"_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"styles/cacl.js":[function(require,module,exports) {
"use strict";
...
function calculator(selector) {
  ...
  var acc = '';
  var input = creator('input', 'calculator__input', false, false, 'value', '0');
  var hint = creator('span', 'calculator__hint', 'Ans = 123');
  var buttons = creator('div', 'calculator-buttons');
  var numbers = options.numbers;
  console.log(eval(fixer('2 ÷ 1 00%')));
  var parent = document.querySelector(selector);
  var btns = btnCreator(numbers, arr1, arr2, 'calculator__button', 'calculator__button--white', 'calculator__button--gray', 'calculator__button--blue');
  buttons.addEventListener('click', function (e) {
    ...
    if (btnContent === '=') {
      ...
      acc = "".concat(eval(fixer(input.value)));
    }

    if (acc !== '' && acc !== undefined) {
      hint.textContent = "".concat(eval(fixer(input.value)));
    }
  });
  btns.forEach(function (btn) {
    return buttons.insertAdjacentElement('beforeend', btn);
  });
...
function fixer(str) {
  return str.replace(/÷/gi, '/').replace(/%/gi, '/100').replace(/\s/gi, '');
}
...
var _cacl = require("./styles/cacl.js");

(0, _cacl.calculator)('#calculator', {
  numbers: [')', '(', '%', 'AC', '7', '8', '9', '÷', '4', '5', '6', '*', '1', '2', '3', '-', '0', '.', '=', '+']
});
},{"./styles/style.scss":"styles/style.scss","./styles/cacl.js":"styles/cacl.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
